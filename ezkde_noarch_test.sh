...
KDE_GROUP[Fedora]="plasma-workspace dolphin konsole" # "plasma-desktop plasma-workspace plasma-workspace-wayland sddm dolphin konsole pipewire pipewire-pulseaudio pipewire-alsa plasma-browser-integration kscreen kinfocenter kmenuedit ksystemstats kwalletmanager5 kwin kwin-wayland plasmashell"
